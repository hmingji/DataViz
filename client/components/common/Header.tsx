    ...
    <header className="container mx-auto px-2 py-10 flex justify-center">
      <div className="max-w-[90vw] xl:max-w-5xl flex justify-left w-full">
        <div className="max-w-2xl">
          <h1
            className={`lg:text-6xl text-5xl ${playfairDisplay.className} font-semibold text-red-900`}
          >
            What are the blood donation trends in Malaysia
          </h1>
          <p
            className={`lg:text-lg text-md text-black py-4 ${inter.className} font-normal tracking-widest`}
          >
