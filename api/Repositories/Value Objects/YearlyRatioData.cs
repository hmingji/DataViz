...
{
    public class YearlyRatioData : RecentRatioData
    {
        ...
        public YearlyDonationVariable mapIntoYearlyVariables()
        {
            ...
            return new YearlyDonationVariable(
                this.year,
                new List<DonationVariable>() { bloodGroup, location, type, social, donor }
            );
        }
    }
}
