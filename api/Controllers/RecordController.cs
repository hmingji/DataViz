...
namespace api.Controllers
{
    ...
    public class RecordController : ControllerBase
    {
        ...
        public async Task<ActionResult<DataResponse<TimeSeriesData>>> GetDailyDonationData(string attribute, [FromQuery] RecordParams recordParams)
        {
        ...
        public async Task<ActionResult<DataResponse<TimeSeriesData>>> GetMonthlyDonationData(string attribute, [FromQuery] RecordParams recordParams)
        {
        ...
        public async Task<ActionResult<DataResponse<TimeSeriesData>>> GetYearlyDonationData(string attribute, [FromQuery] RecordParams recordParams)
        {
        ...
        public async Task<ActionResult<DataResponse<TimeSeriesData>>> GetDailyNewDonorData(string attribute, [FromQuery] RecordParams recordParams)
        {
        ...
        public async Task<ActionResult<DataResponse<TimeSeriesData>>> GetMonthlyNewDonorData(string attribute, [FromQuery] RecordParams recordParams)
        {
        ...
        public async Task<ActionResult<DataResponse<TimeSeriesData>>> GetYearlyNewDonorData(string attribute, [FromQuery] RecordParams recordParams)
        {
